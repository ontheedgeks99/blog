                            ...
                            @else
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                        <a class="dropdown-item" href="{{ url('post/list') }}">記事投稿</a>
                                        <a class="dropdown-item" href="{{ url('post/category') }}">カテゴリー</a>
                                        <a class="dropdown-item" href="{{ url('profile') }}">プロフィール</a>
                                        <a class="dropdown-item" href="{{ url('portfolio/form') }}">ポートフォリオ</a>
